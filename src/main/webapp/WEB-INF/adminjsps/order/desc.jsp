...
<script type="text/javascript">
  ...
  <form style="margin:20px;" id="form" action="" method="post" enctype="multipart/form-data">
  	...
  	日租单价：<input style="width: 150px; height: 20px;" type="text" name="dayprice" value="${book.dayprice }"/><br/>
           图书数量：<input style="width: 150px; height: 20px;" type="text" name="count" value="${book.count }"/><br/>
  	...
  	图书分类：<select style="width: 150px; height: 20px;" name="cid">
   	...
   	出版信息：<select style="width: 150px; height: 20px;" name="pid">
